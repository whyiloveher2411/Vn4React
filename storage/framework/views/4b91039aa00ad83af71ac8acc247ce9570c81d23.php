			...
			<div class="uk-grid-small uk-child-width-1-2 uk-child-width-1-3@s uk-child-width-1-6@m" uk-grid>
						...
						<div class="tm-ratio tm-ratio-4-3">
							<div class="tm-media-box">
								<figure class="tm-media-box-wrap"><img class="item-brand"
										src="/themes/vn4cms-ecommerce/images/catalog/laptops.png" alt="Laptops"></figure>
							</div>
						</div>
				...
				<div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
						...
						<div class="tm-ratio tm-ratio-4-3">
							<div class="tm-media-box">
								<figure class="tm-media-box-wrap"><img class="item-brand"
										src="/themes/vn4cms-ecommerce/images/catalog/smartphones.png" alt="Smartphones"></figure>
							</div>
						</div>
						<div class="uk-margin-small-top">
				...
				<div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
						...
						<div class="tm-ratio tm-ratio-4-3">
							<div class="tm-media-box">
								<figure class="tm-media-box-wrap"><img class="item-brand"
										src="/themes/vn4cms-ecommerce/images/catalog/tablets.png" alt="Tablets"></figure>
							</div>
						</div>
						<div class="uk-margin-small-top">
				...
				<div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
						...
						<div class="tm-ratio tm-ratio-4-3">
							<div class="tm-media-box">
								<figure class="tm-media-box-wrap"><img class="item-brand"
										src="/themes/vn4cms-ecommerce/images/catalog/watches.png" alt="Smart Watches"></figure>
							</div>
						</div>
						<div class="uk-margin-small-top">
				...
				<div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
						...
						<div class="tm-ratio tm-ratio-4-3">
							<div class="tm-media-box">
								<figure class="tm-media-box-wrap"><img class="item-brand"
										src="/themes/vn4cms-ecommerce/images/catalog/consoles.png" alt="Gaming Consoles"></figure>
							</div>
						</div>
						<div class="uk-margin-small-top">
				...
				<div><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
						...
						<div class="tm-ratio tm-ratio-4-3">
							<div class="tm-media-box">
								<figure class="tm-media-box-wrap"><img class="item-brand"
										src="/themes/vn4cms-ecommerce/images/catalog/cameras.png" alt="Cameras"></figure>
							</div>
						</div>
						<div class="uk-margin-small-top">
			...
			<div class="uk-card uk-card-default tm-ignore-container">
				<div class="uk-grid-collapse uk-child-width-1-3 uk-child-width-1-4@m tm-products-grid" uk-grid>
					<article class="tm-product-card">
						<div class="tm-product-card-media">
							<div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product">
									...
									<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/products/1/1-medium.jpg"
						...
						<div class="tm-product-card-media">
							<div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product">
									<div class="tm-product-card-labels"><span
											...
											class="uk-label uk-label-danger">trade-in</span></div>
									<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/products/2/2-medium.jpg"
					...
					<article class="tm-product-card">
						<div class="tm-product-card-media">
							<div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product">
									<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/products/3/3-medium.jpg"
					...
					<article class="tm-product-card">
						<div class="tm-product-card-media">
							<div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product">
									...
									<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/products/4/4-medium.jpg"
					...
					<article class="tm-product-card">
						<div class="tm-product-card-media">
							<div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product">
									<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/products/5/5-medium.jpg"
					...
					<article class="tm-product-card">
						<div class="tm-product-card-media">
							<div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product">
									<div class="tm-product-card-labels"><span
											class="uk-label uk-label-danger">trade-in</span></div>
									<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/products/6/6-medium.jpg"
					...
					<article class="tm-product-card">
						<div class="tm-product-card-media">
							<div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product">
									<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/products/7/7-medium.jpg"
					...
					<article class="tm-product-card">
						<div class="tm-product-card-media">
							<div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box" href="product">
									...
									<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/products/8/8-medium.jpg"
							...
							<ul
								...
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											...
											title="Apple">
											<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/brands/apple.svg"
													alt="Apple"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											...
											<figure class="tm-media-box-wrap"><img
													src="/themes/vn4cms-ecommerce/images/brands/samsung.svg" alt="Samsung"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											class="uk-link-muted tm-media-box tm-grayscale" href="#"
											title="Sony">
											<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/brands/sony.svg"
													alt="Sony"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											...
											title="Microsoft">
											<figure class="tm-media-box-wrap"><img
													src="/themes/vn4cms-ecommerce/images/brands/microsoft.svg" alt="Microsoft"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											class="uk-link-muted tm-media-box tm-grayscale" href="#"
											title="Intel">
											<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/brands/intel.svg"
													alt="Intel"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											...
											<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/brands/hp.svg"
													alt="HP"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											...
											<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/brands/lg.svg"
													alt="LG"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											...
											title="Lenovo">
											<figure class="tm-media-box-wrap"><img
													src="/themes/vn4cms-ecommerce/images/brands/lenovo.svg" alt="Lenovo"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											class="uk-link-muted tm-media-box tm-grayscale" href="#"
											title="ASUS">
											<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/brands/asus.svg"
													alt="ASUS"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											class="uk-link-muted tm-media-box tm-grayscale" href="#"
											title="Acer">
											<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/brands/acer.svg"
													alt="Acer"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											class="uk-link-muted tm-media-box tm-grayscale" href="#"
											title="Dell">
											<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/brands/dell.svg"
													alt="Dell"></figure>
										</a></div>
								</li>
								<li>
									<div class="tm-ratio tm-ratio-16-9"><a
											class="uk-link-muted tm-media-box tm-grayscale" href="#"
											title="Canon">
											<figure class="tm-media-box-wrap"><img src="/themes/vn4cms-ecommerce/images/brands/canon.svg"
													alt="Canon"></figure>
										</a></div>
								</li>
							</ul>
			...
			<div class="uk-grid-medium uk-grid-match uk-child-width-1-1 uk-child-width-1-2@s" uk-grid>
						...
						<article
							...
							<div class="tm-ratio tm-ratio-16-9">
								<figure class="tm-media-box uk-cover-container uk-margin-remove"><img
										src="/themes/vn4cms-ecommerce/images/articles/macbook-photo.jpg"
				...
				<div><a href="article">
						<article
							...
							<div class="tm-ratio tm-ratio-16-9">
								<figure class="tm-media-box uk-cover-container uk-margin-remove"><img
										src="/themes/vn4cms-ecommerce/images/articles/macos.jpg" alt="Apple introduces macOS Mojave"
										uk-cover="uk-cover" /></figure>
							</div>
							<div class="uk-card-body">
								<div class="uk-article-body">
