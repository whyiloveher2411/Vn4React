        ...
        <div class="uk-container" uk-navbar>
            <div class="uk-navbar-left">
                <button class="uk-navbar-toggle uk-hidden@m" uk-toggle="target: #nav-offcanvas" uk-navbar-toggle-icon></button>
                    <a class="uk-navbar-item uk-logo" href="<?php echo route('index'); ?>">
                        <img src="/themes/vn4cms-ecommerce/images/logo.svg" width="90" height="32" alt="Logo">
                    </a>
                    <?php echo vn4_nav_menu('nav-header','nav-header'); ?>
