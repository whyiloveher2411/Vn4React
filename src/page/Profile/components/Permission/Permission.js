            ...
            <CardContent>
...

                {
                    permissions && listGroupPermission ?
                        <Grid container spacing={4} className={classes.content} style={!setting.role || setting.role === 'custom' || setting.role === '' ? {} : { pointerEvents: 'none', background: '#dedede', opacity: '.65' }}>
