...
tinymce.PluginManager.add('filemanager', function (editor) {
    ...
    function filemanager(callback, value, meta) {
        ...
        // DEFAULT AS FILE
        urltype = ['ext_file', 'ext_image', 'ext_misc', 'ext_video', 'ext_music'];
        if (meta.filetype === 'image' || meta.mediaType === 'image') { urltype = 'ext_image'; }
        if (meta.filetype === 'media' || meta.mediaType === 'media') { urltype = ['ext_video', 'ext_music']; }
        ...
        window.__insertEditImageCallback = callback;

        editor.settings.OpenFileManager(urltype);
