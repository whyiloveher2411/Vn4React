...
!function(s) {
    ...
    t = void 0,
    function(e) {
        "object" == typeof n && void 0 !== o ? o.exports = e() : "function" == typeof t && t.amd ? t([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EphoxContactWrapper = e()
    }(function() {
                        ...
                        function r(n, o) {
                            ...
                            i._immediateFn(function() {
                                ...
                                if (null !== e) {
                                    ...
                                    (1 === n._state ? c : u)(o.promise, n._value)
                            })) : n._deferreds.push(o)
                        }
                        function c(t, e) {
                            try {
    ...
    var l = r.exports.boltExport
      ...
      , m = function(e, t, n) {
        var o, r, i, c, u, a;
        e in f ? (u = n,
        null === (a = f[e]).module ? a.callbacks.push(u) : u(a.module)) : (o = e,
        r = t,
        i = n,
        c = s.document.createElement("script"),
        tinymce.codeMirrorLazyLoader = {
            define: d
        },
        f[o] = {
            module: null,
      ...
      , p = {
        ...
        setupCodeMirrorInstance: function(e, t, n, o) {
            var r, i, c = (r = e,
            {
                ...
                completeIfInTag: function(t) {
                    return i(t, function() {
                        ...
                        return !!("string" !== e.type || /['"]/.test(e.string.charAt(e.string.length - 1)) && 1 !== e.string.length) && r.innerMode(t.getMode(), e.state).state.tagName
                    })
                }
            }), u = e(function(e) {
                t.appendChild(e)
            ...
            return tinymce.DOM.bind(t, "keyup keydown keypress", function(e) {
        ...
        show: function(s, l) {
            ...
            i(s, {
                ...
                body: {
                    ...
                    minHeight: s.getParam("code_dialog_height", Math.min(tinymce.DOM.getViewPort().h - 200, 500))
                },
                onPostRender: function(e) {
                    ...
                    h.renderTo(o, r, t, n, h.fromTinySettings(s.settings)).then(function(e) {
                        f = e
                    })
                },
                onSubmit: function() {
      ...
      , a = {
        show: function(r, e) {
            var t, n, o, i, c = (t = r.settings,
            n = e,
            t.codemirror_script || n + "/codemirror.min.js"), u = (o = r.settings,
            i = e,
            o.codemirror_css || i + "/codemirror.min.css"), a = r.getContent({
                source_view: !0
      ...
      , C = function(e, t) {
        return -1 === function(e, t) {
            ...
            return 0 !== r ? r : 0
        }((n = e) ? T([(o = n).majorVersion, o.minorVersion].join(".").split(".").slice(0, 3).join(".")) : null, T(t));
        var n, o
    }
      , x = function(e, t, n) {
        return function() {
    ...
    tinymce.PluginManager.add("advcode", function(e, t) {
        return C(tinymce, "4.3.13") ? (v.error("The advcode plugin requires at least 4.3.13 version of TinyMCE."),
        function() {}
        ) : (C(tinymce, "5.0.0") ? (c = x(u, i = e, t),
