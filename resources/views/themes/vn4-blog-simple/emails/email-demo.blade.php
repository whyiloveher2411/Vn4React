<div class="container">
    <div class="emailform" style="background-color: #f4f7f6; max-width: 590px;margin: 20px auto;font-family: arial;line-height: 24px;">
        <div class="inner" style="padding:50px;">
            <div class="logo"><img src="img/logo.svg" alt="" style="width:100px;margin-bottom: 10px;"></div>
            <div class="content">
                <h2>Đăng ký khóa học tại CFD.</h2>
                <p>Chào mừng tân binh <strong>Trần Nghĩa</strong>,</p>
                <p>
                    Bạn đã đăng ký khóa học <a href="#" target="_blank" style="text-decoration: none;color:#00afab"><strong>CFD2 Căn Bản</strong></a> tại <strong>CFD</strong> thành công, chúng tôi sẽ chủ động liên hệ thông qua số điện thoại của bạn.
                </p>
                <a href="#"  target="_blank" class="btn" style="background-color: #00afab; border-radius: 50px;
