            ...
            <div class="uk-grid-medium uk-child-width-1-1" uk-grid>
                <div class="uk-text-center">
                    <ul class="uk-breadcrumb uk-flex-center uk-margin-remove">
                        ...
                        <li><span>Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)</span></li>
                    </ul>
                    <h1 class="uk-margin-small-top uk-margin-remove-bottom">Apple MacBook Pro 15&quot; Touch Bar
                        MPTU2LL/A 256GB (Silver)</h1>
                </div>
                <div>
                    <div class="uk-grid-medium uk-child-width-1-1" uk-grid>
                        <div>
                                            ...
                                            <div>
                                                <ul class="uk-slideshow-items" uk-lightbox>
                                                    <li><a class="uk-card-body tm-media-box tm-media-box-zoom"
                                                            href="@theme_asset()images/products/1/1-large.jpg">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="@theme_asset()images/products/1/1-large.jpg"
                                                                    alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                            </figure>
                                                        </a></li>
                                                    <li><a class="uk-card-body tm-media-box tm-media-box-zoom"
                                                            href="@theme_asset()images/products/1/1-add-1-large.jpg">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="@theme_asset()images/products/1/1-add-1-large.jpg"
                                                                    alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                            </figure>
                                                        </a></li>
                                                    <li><a class="uk-card-body tm-media-box tm-media-box-zoom"
                                                            href="@theme_asset()images/products/1/1-add-2-large.jpg">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="@theme_asset()images/products/1/1-add-2-large.jpg"
                                                                    alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                            </figure>
                                                        </a></li>
                                                    <li><a class="uk-card-body tm-media-box tm-media-box-zoom"
                                                            href="@theme_asset()images/products/1/1-add-3-large.jpg">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="@theme_asset()images/products/1/1-add-3-large.jpg"
                                                                    alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                            </figure>
                                                        </a></li>
                                                    <li><a class="uk-card-body tm-media-box tm-media-box-zoom"
                                                            href="@theme_asset()images/products/1/1-add-4-large.jpg">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="@theme_asset()images/products/1/1-add-4-large.jpg"
                                                                    alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                            </figure>
                                                        </a></li>
                                                </ul>
                                                                            ...
                                                                            <div class="tm-ratio tm-ratio-1-1">
                                                                                <a
                                                                                    ...
                                                                                    <figure
                                                                                        ...
                                                                                        <img src="@theme_asset()images/products/1/1-small.jpg"
                                                                                            alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                                                    </figure>
                                                                                </a></div>
                                                                        </li>
                                                                        <li uk-slideshow-item="1">
                                                                            <div class="tm-ratio tm-ratio-1-1">
                                                                                <a class="tm-media-box tm-media-box-frame"
                                                                                    ...
                                                                                    <figure
                                                                                        class="tm-media-box-wrap">
                                                                                        <img src="@theme_asset()images/products/1/1-add-1-small.jpg"
                                                                                            alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                                                    </figure>
                                                                                </a></div>
                                                                        </li>
                                                                        <li uk-slideshow-item="2">
                                                                            <div class="tm-ratio tm-ratio-1-1">
                                                                                <a class="tm-media-box tm-media-box-frame"
                                                                                    ...
                                                                                    <figure
                                                                                        class="tm-media-box-wrap">
                                                                                        <img src="@theme_asset()images/products/1/1-add-2-small.jpg"
                                                                                            alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                                                    </figure>
                                                                                </a></div>
                                                                        </li>
                                                                        <li uk-slideshow-item="3">
                                                                            <div class="tm-ratio tm-ratio-1-1">
                                                                                <a class="tm-media-box tm-media-box-frame"
                                                                                    ...
                                                                                    <figure
                                                                                        class="tm-media-box-wrap">
                                                                                        <img src="@theme_asset()images/products/1/1-add-3-small.jpg"
                                                                                            alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                                                    </figure>
                                                                                </a></div>
                                                                        </li>
                                                                        <li uk-slideshow-item="4">
                                                                            <div class="tm-ratio tm-ratio-1-1">
                                                                                <a class="tm-media-box tm-media-box-frame"
                                                                                    ...
                                                                                    <figure
                                                                                        class="tm-media-box-wrap">
                                                                                        <img src="@theme_asset()images/products/1/1-add-4-small.jpg"
                                                                                            alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                                                    </figure>
                                                                                </a></div>
                                                                        </li>
                                        ...
                                        <div class="uk-card-body">
                                            ...
                                            <div class="uk-margin">
                                                <div class="uk-grid-medium" uk-grid>
                                                    <div>
                                                        <div class="uk-text-small uk-margin-xsmall-bottom">Color
                                                        </div>
                                                        <ul class="uk-subnav uk-subnav-pill tm-variations"
                                                            uk-switcher>
                                                            <li><a class="tm-variation-color"
                                                                    uk-tooltip="Space Grey">
                                                                    <div style="background-color: #aaaeb1">
                                                                    </div>
                                                                </a></li>
                                                            <li><a class="tm-variation-color"
                                                                    uk-tooltip="Silver">
                                                    ...
                                                    <div>
                                                        <div class="uk-text-small uk-margin-xsmall-bottom">SSD
                                                            Storage</div>
                                                        <ul class="uk-subnav uk-subnav-pill tm-variations"
                                                            uk-switcher>
                                                            <li><a>256 GB</a></li>
                                            ...
                                            <div class="uk-margin">
                                                <div
                                                    ...
                                                    <div class="uk-grid-small uk-child-width-1-1" uk-grid>
                                                        <div><del class="uk-text-meta">$1899.00</del>
                                                            <div class="tm-product-price">$1599.00</div>
                                                        </div>
                                                        <div>
                                                            <div class="uk-grid-small" uk-grid>
                                                                <div><a onclick="increment(-1, 'product-1')"
                                                                        uk-icon="icon: minus; ratio: .75"></a><input
                                                                        class="uk-input tm-quantity-input"
                                                                        id="product-1" type="text" maxlength="3"
                                                                        value="1" /><a
                                                    ...
                                                    <article class="uk-article">
                                                        <div class="uk-article-body">
                                                            ...
                                                            <div class="tm-wrapper uk-text-center">
                                                                <figure><a
                                                                        href="@theme_asset()images/articles/macbook-photo.jpg"><img
                                                            ...
                                                            <figure class="uk-text-center"><a
                                                                    href="@theme_asset()images/articles/macbook-promo-4.jpg"><img
                                                                        src="@theme_asset()images/articles/macbook-promo-4.jpg"
                                                            ...
                                                            <div class="tm-wrapper">
                                                                <figure class="uk-text-center"><a
                                                                        href="@theme_asset()images/articles/macbook-promo-3.jpg"><img
                                                                ...
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            <figure class="tm-media-box-wrap">
                                                                                <img src="@theme_asset()images/products/1/1-medium.jpg"
                                                                                    alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)" />
                                                                            </figure>
                                                                        </a></div>
                                                                </div>
                                                            ...
                                                            <article class="tm-product-card">
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            <figure class="tm-media-box-wrap">
                                                                                <img src="@theme_asset()images/products/2/2-medium.jpg"
                                                            ...
                                                            <article class="tm-product-card">
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            href="product">
                                                                            <figure class="tm-media-box-wrap">
                                                                                <img src="@theme_asset()images/products/3/3-medium.jpg"
                                                                    ...
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            <div class="tm-product-card-labels">
                                                                                <span
                                                                                    ...
                                                                                    selling</span></div>
                                                                            <figure class="tm-media-box-wrap">
                                                                                <img src="@theme_asset()images/products/4/4-medium.jpg"
                                                            ...
                                                            <article class="tm-product-card">
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            href="product">
                                                                            <figure class="tm-media-box-wrap">
                                                                                <img src="@theme_asset()images/products/5/5-medium.jpg"
                                                            ...
                                                            <article class="tm-product-card">
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            <figure class="tm-media-box-wrap">
                                                                                <img src="@theme_asset()images/products/6/6-medium.jpg"
                                                            ...
                                                            <article class="tm-product-card">
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            href="product">
                                                                            <figure class="tm-media-box-wrap">
                                                                                <img src="@theme_asset()images/products/7/7-medium.jpg"
                                                            ...
                                                            <article class="tm-product-card">
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            <figure class="tm-media-box-wrap">
                                                                                <img src="@theme_asset()images/products/8/8-medium.jpg"
                                            ...
                                            <div class="uk-slider-container">
                                                <div
                                                    ...
                                                    <article class="tm-product-card">
                                                        <div class="tm-product-card-media">
                                                            <div class="tm-ratio tm-ratio-4-3"><a
                                                                    class="tm-media-box" href="product">
                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title"><a
                                                                        class="uk-link-heading"
                                                                        href="product">Apple MacBook Pro
                                                    ...
                                                    <article class="tm-product-card">
                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title"><a
                                                                        class="uk-link-heading"
                                                                        href="product">Lenovo IdeaPad YOGA
                                                    ...
                                                    <article class="tm-product-card">
                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title"><a
                                                                        class="uk-link-heading"
                                                                        href="product">Apple MacBook Air
                                                    ...
                                                    <article class="tm-product-card">
                                                        ...
                                                        <div class="tm-product-card-body">
                                                            <div class="tm-product-card-info">
                                                                ...
                                                                <h3 class="tm-product-card-title"><a
                                                                        class="uk-link-heading"
                                                                        href="product">Lenovo ThinkPad X380
