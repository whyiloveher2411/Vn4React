                ...
                <div class="uk-card uk-card-default uk-overflow-auto tm-ignore-container">
                    <table class="uk-table uk-table-divider tm-compare-table">
                        <thead>
                            ...
                            <td class="uk-table-middle uk-text-center tm-compare-column"><input class="tm-checkbox" id="show-difference" type="checkbox"><label for="show-difference">Show differences only</label></td>
                            <td class="tm-compare-table-column">
                                <div class="uk-height-1-1">
                                    <div class="uk-grid-small uk-child-width-1-1 uk-height-1-1" uk-grid>
                                        <div class="uk-text-center"><a class="uk-text-small uk-text-danger" href="#"><span uk-icon="icon: close; ratio: .75;"></span><span class="uk-margin-xsmall-left tm-pseudo">Delete</span></a></div>
                                        <div>
                                        <div class="uk-grid-small uk-height-1-1" uk-grid="uk-grid">
                                            <div class="uk-width-1-3">
                                                <div class="tm-ratio tm-ratio-4-3">
                                                    <a class="tm-media-box" href="product.html">
                                                    <figure class="tm-media-box-wrap"><img src="@theme_asset()images/products/1/1-small.jpg" alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)"/></figure>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="uk-width-expand">
                                                <div class="tm-product-card-body uk-padding-remove uk-height-1-1">
                                                    ...
                                                    <a class="tm-product-card-title" href="product.html">Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)</a>
                                                    </div>
                                                    ...
                                                    <div class="tm-product-card-add"><button class="uk-button uk-button-primary tm-product-card-add-button tm-shine js-add-to-cart"><span class="tm-product-add-button-icon" uk-icon="cart"></span><span class="tm-product-card-add-button-text">add to cart</span></button></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="uk-grid-small uk-child-width-1-1 uk-height-1-1" uk-grid>
                                        ...
                                        <div class="uk-grid-small uk-height-1-1" uk-grid="uk-grid">
                                            <div class="uk-width-1-3">
                                                <div class="tm-ratio tm-ratio-4-3">
                                                    <a class="tm-media-box" href="product.html">
                                                    <figure class="tm-media-box-wrap"><img src="@theme_asset()images/products/2/2-small.jpg" alt="Apple MacBook 12&quot; MNYN2LL/A 512GB (Rose Gold)"/></figure>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="uk-width-expand">
                                                <div class="tm-product-card-body uk-padding-remove uk-height-1-1">
                                                    <div class="tm-product-card-info">
                                                    <div class="uk-text-meta uk-margin-xsmall-bottom">Laptop</div>
                                                    <a class="tm-product-card-title" href="product.html">Apple MacBook 12&quot; MNYN2LL/A 512GB (Rose Gold)</a>
                                                    </div>
                                                    <div class="tm-product-card-shop">
                                                    <div class="tm-product-card-prices">
                                    ...
                                    <div class="uk-grid-small uk-child-width-1-1 uk-height-1-1" uk-grid>
                                        ...
                                        <div class="uk-grid-small uk-height-1-1" uk-grid="uk-grid">
                                            <div class="uk-width-1-3">
                                                <div class="tm-ratio tm-ratio-4-3">
                                                    <a class="tm-media-box" href="product.html">
                                                    <figure class="tm-media-box-wrap"><img src="@theme_asset()images/products/6/6-small.jpg" alt="Apple MacBook Air 13&quot; MQD32LL/A 128GB (Silver)"/></figure>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="uk-width-expand">
                                                <div class="tm-product-card-body uk-padding-remove uk-height-1-1">
                                                    <div class="tm-product-card-info">
                                                    <div class="uk-text-meta uk-margin-xsmall-bottom">Laptop</div>
                                                    <a class="tm-product-card-title" href="product.html">Apple MacBook Air 13&quot; MQD32LL/A 128GB (Silver)</a>
                                                    </div>
                                                    <div class="tm-product-card-shop">
                                                    <div class="tm-product-card-prices">
                        ...
                        <tbody>
                            ...
                            <td>1 × DisplayPort&nbsp;1.2&nbsp;via Optional Cable,<br>1 × HDMI&nbsp;via Optional Cable,<br>1 × VGA&nbsp;via Optional Cable</td>
                            <td>1 × Mini DisplayPort&nbsp;via Thunderbolt Port</td>
                            </tr>
                            <tr>
                            <th>Audio</th>
                            <td>1 × 1/8" (3.5&nbsp;mm) Headphone Output,<br>2 × Integrated Speaker,<br>3 × Integrated Microphone</td>
                            <td>1 × 1/8" (3.5&nbsp;mm) Headphone Output,<br>2 × Integrated Speaker,<br>2 × Integrated Microphone</td>
                            <td>1 × 1/8" (3.5&nbsp;mm) Headphone Output,<br>2 × Integrated Speaker,<br>2 × Integrated Microphone</td>
                            </tr>
                            <tr>
