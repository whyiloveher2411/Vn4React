...
add_action('vn4_footer',function(){
  ?>
   <script>
      ...
      $('.meta-box-user-permission .col-right').css({'max-height':$('.meta-box-user-permission .col-left:first').height()});
...
<div class="controls-header">
  ...
  <div class="header-col-right">
      ...
      <label>@__('Quick filter'): <input class="form-control input-quick-filter" onkeyup="ure_filter_capabilities(slug(this.value));" type="text"></label>&nbsp;&nbsp;
...
<div class="col-right number-column-3">
  ...
  <?php 
    ...
    echo show_permssion_right($list_permission,$list_role,'all-p');
   ?>
