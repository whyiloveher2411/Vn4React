<tr class="field_option field_option_repeater">
    ...
    <td>
      <?php 
        echo '<div class="aptp-fields repeater">';
          ...
          vn4_panel('<div class="w25">Field Order</div><div class="w25">Field Label</div><div class="w25">Field Name</div><div class="w25">Field Type</div>',function() use ($sub_fields, $id_field,$__env,$plugin){
            ...
            ?>
              ...
              @foreach( $sub_fields as $field)
                  ...
                  <?php 
                      ...
                      $id_field2 = $id_field.'][repeater][sub_fields][field_'.str_random(12);
                   ...
                   ?>
                  {!!view_plugin($plugin,'views.field',['index'=>$index,'name_field'=>'fields['.$id_field.'][repeater][sub_fields][field-key][]','field'=>$field,'fieldType'=>$fieldType,'fieldTypeAttribute'=>$fieldTypeAttribute,'id_field'=>$id_field2])!!}
                  <?php ++$index; ?>
              @endforeach
              @endif
            ...
            <?php
              ...
              ?>  
                  ...
                  <span class="vn4-btn vn4-btn-blue pull-right btn-add-field sub-fields-repeater">+ Add Field</span>
...
<tr class="field_option field_option_repeater">
    ...
    <td>
      <label><input type="radio" @if($layout === 'table') checked="checked" data-checked="1" @endif  name="fields[{!!$id_field!!}][repeater][layout]" value="table" class="change_name form-control">Table</label>&nbsp;&nbsp;
      <label><input @if($layout === 'block') checked="checked" data-checked="1" @endif type="radio" name="fields[{!!$id_field!!}][repeater][layout]" value="block" class="change_name form-control">Block</label>
    </td>
</tr>
<tr class="field_option field_option_repeater">
    <td class="td-label">
