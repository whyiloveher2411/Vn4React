       ...
       @if($filter)
            ...
            if( $('#rt_country').length ){
              ...
              google.visualization.events.addListener(window.charts.rt_country, 'ready', function(){
                ...
                var height = document.querySelector('#warper-realtime').offsetHeight;
...
?>
   ...
   <!--  <select id="change_website">
    ...
    <div style="display: flex;padding-top: 10px;" id="warper-realtime">
    <div class="column-left" style="width: 32.999%;text-align: center;display: inline-block;box-sizing: border-box;padding:0 5px 0 0; ">
    ...
    <div class="column-right" style="width: 66.999%;display: inline-block;">
      <div class="card">
