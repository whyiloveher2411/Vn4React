...
<div class="table_chart">
	...
	<table style="width: 100%;" >
		...
		<tbody>
			...
			@foreach($data_age_total['ga:userGender'] as $k => $v)
...
<script type="text/javascript">
	...
	google.charts.load('current', {'packages':['corechart']});
  	...
  	function drawChart(){
	      ...
	      [{type: 'datetime', label: 'Date'},'User','female','male'],

	      @foreach($data_new as $k => $v)

	      [{v:new Date('{!!date("M d, Y", strtotime($k))!!}'),f:'{!!date("l, F d, Y", strtotime($k))!!}'}, {!!$v['female']+$v['male']!!} , {!!$v['female']!!}, {!!$v['male']!!}],
	    ...
	    var options = {
	      ...
	      series: {
			  ...
			  0:{color: '#058DC7', visibleInLegend: false},

			  1:{areaOpacity :0, lineWidth: 0, pointSize:0 , visibleInLegend: false},

			  2:{color: '#50B432', visibleInLegend: false}
